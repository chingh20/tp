...
public class GameEntryUtil {
    ...
    public static String getEditGameEntryDescriptorDetails(EditGameEntryDescriptor descriptor) {
        StringBuilder sb = new StringBuilder();
        descriptor.getGameType().ifPresent(game ->   sb.append(PREFIX_GAMETYPE + descriptor.getGameType().get() + " "));
        descriptor.getStartAmount().ifPresent(start -> sb.append(PREFIX_STARTAMOUNT
                + descriptor.getStartAmount().get().toString() + " "));
        descriptor.getEndAmount().ifPresent(end -> sb.append(PREFIX_ENDAMOUNT
                + descriptor.getEndAmount().get().toString() + " "));
        descriptor.getDate().ifPresent(date-> sb.append(PREFIX_DATE + descriptor.getDate().get().toString() + " "));
        descriptor.getDuration().ifPresent(duration ->  sb.append(PREFIX_DURATION
                + descriptor.getDuration().get().toString() + " "));
        descriptor.getLocation().ifPresent(location -> sb.append(PREFIX_LOCATION + descriptor.getLocation().get() + " "));
