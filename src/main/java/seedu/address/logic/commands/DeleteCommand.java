...
public class DeleteCommand extends Command {
    ...
    public static final String MESSAGE_DELETE_GAME_SUCCESS = "Deleted Game Entry: %1$s";
    ...
    public CommandResult execute(Model model) throws CommandException {
        ...
        return new CommandResult(String.format(MESSAGE_DELETE_GAME_SUCCESS, gameEntryToDelete));
    }
